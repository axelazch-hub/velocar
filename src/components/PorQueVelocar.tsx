        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {razones.map((razon) => (
            <div key={razon.title} className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-md bg-velocar-orange/10 text-velocar-orange mb-5">
                {razon.icon}
              </div>
              <h3 className="font-[family-name:var(--font-heading)] text-xl font-extrabold text-white mb-2">
                {razon.title}
              </h3>
